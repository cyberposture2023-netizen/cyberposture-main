  ...
  return (
    <>
      ...
      <section
        ...
        style={{ background: "linear-gradient(160deg,#1A1340,#2A2270 70%,#0A2342)" }}
      >
        {/* Grid texture */}
        <div
        ...
        <div className="container-content relative py-[72px] pb-16">
          ...
          <p className="text-[17px] leading-[1.6] mb-7 max-w-[730px]" style={{ color: "#C7CCF0" }}>
      ...
      <section className="bg-white">
        <div className="container-content py-16">
          ...
          >
            ...
            <p className="text-[15px] mx-auto mb-6 max-w-[600px]" style={{ color: "#D9D2FF" }}>

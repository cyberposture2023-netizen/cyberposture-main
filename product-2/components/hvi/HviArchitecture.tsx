  ...
  return (
    <section className="bg-white">
      <div className="container-content py-[72px]">
        ...
        <div className="border border-surface-border rounded-[20px] p-7 bg-[#FCFDFE]">
          {/* Step flow */}
            ...
            {steps.map((step, i) => (
              <Fragment key={step.num}>
                ...
                <div
                  ...
                  style={{ borderTop: "3px solid #12A89B" }}
                >
